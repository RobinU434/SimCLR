...
parser.add_argument(
    ...
    type=float,
    metavar="LR",
    help="maximal learning rate. Linear warmup within 10 epochs"
    "to maximal learning rate and afterwards cosine annealing."
    "Please note that in the SimCLR paper the maximal learning"
    "rate scales with the batchsize: 0.3 * batch_size / 256",
    dest="lr",
)
parser.add_argument(
    "--wd",
...
def main():
    """run training process for Pytorch SimCLR
    """
